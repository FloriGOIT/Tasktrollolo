...
import { ReachHelP } from "../Sidebaring/Children/ReachHelPing";
...
import {BoardDetailsModaL} from "../Sidebaring/Children/BoardModaL";
    ...
    <div className={css.sidebarF} >
      <div>
        ...
        <section className={css.myBoardsF}>
          ...
          <BoardDetailsModaL openModal={openModal} isboardmodalopen={isboardmodalopen} isEditCreat={isEditCreat} handleIconSelect={handleIconSelect}/>
      ...
      <div>
        <ReachHelP openHelpModal={openHelpModal}/>
        <LogOuT />
      </div>
